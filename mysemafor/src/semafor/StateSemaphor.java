...
import static semafor.ColorEnum.NullLamp;
...
public class StateSemaphor implements Runnable {
    ...
    public class NullLampColor extends ChangeColor {
        int col;
        public NullLampColor() {
            count = 100;
            col = 5;
        }
        ...
        public void changeColor() {
            if (col > 0) {
                colorEnum = (colorEnum == NullLamp ? TGreenYellowRed: NullLamp);
                col--;
            }
            else {
                col = 5;
